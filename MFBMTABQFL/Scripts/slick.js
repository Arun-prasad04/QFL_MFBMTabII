    ...
    slick.slider = (function() {
        ...
        slider.prototype.buildOut = function() {
            ...
            if (this.options.arrows === true) {
                ...
                this.prevArrow = $('<a href="javascript:void(0)">Previous</a>').appendTo(this.slider).html('<i class="fas fa-angle-double-left"></i>').addClass('slick-prev');
                this.nextArrow = $('<a href="javascript:void(0)">Next</a>').appendTo(this.slider).html('<i class="fas fa-angle-double-right"></i>').addClass('slick-next');
        ...
        slider.prototype.slideHandler = function (index) {
            ...
            //alert(self.options.slickqgates);
            if (Validation == "Ok" || index > self.options.slickqgates) {
                Validation = "";
                return false;
            ...
            if (targetSlide < 0) {
                ...
                this.animateSlide(targetLeft, function(){
                    ...
                    if (self.options.arrows === true && self.options.infinite !== true) {
                        ...
                        else if (self.options.slickqgates == self.currentSlide)
                        {
                            Validation = "Ok";
